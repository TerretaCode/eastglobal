...
const Footer = () => {
    ...
    return (
        <footer className="bg-black border-t border-white/5 pt-20 pb-10 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#EBC7DD]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#EBC7DD]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="flex space-x-4">
                            <a
                                ...
                                className="w-12 h-12 bg-gray-900 border border-white/5 rounded-2xl flex items-center justify-center hover:bg-[#EBC7DD] hover:border-[#EBC7DD] transition-all duration-300 text-gray-400 hover:text-black group"
                            >
                    ...
                    <div className="space-y-8">
                        ...
                        <nav className="flex flex-col space-y-4">
                            <Link to="/" className="text-gray-400 hover:text-[#EBC7DD] transition-colors">Inicio</Link>
                            <Link to="/servicios" className="text-gray-400 hover:text-[#EBC7DD] transition-colors">Servicios</Link>
                            <Link to="/proyectos" className="text-gray-400 hover:text-[#EBC7DD] transition-colors">Proyectos</Link>
                            <Link to="/nosotros" className="text-gray-400 hover:text-[#EBC7DD] transition-colors">Sobre nosotros</Link>
                            <Link to="/contacto" className="text-gray-400 hover:text-[#EBC7DD] transition-colors">Contacto</Link>
                        </nav>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col space-y-6">
                            <div className="flex items-start space-x-4">
                                <div className="w-10 h-10 bg-[#EBC7DD]/10 rounded-xl flex items-center justify-center shrink-0">
                                    <Mail className="w-5 h-5 text-[#EBC7DD]" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-start space-x-4">
                                <div className="w-10 h-10 bg-[#EBC7DD]/10 rounded-xl flex items-center justify-center shrink-0">
                                    <Phone className="w-5 h-5 text-[#EBC7DD]" />
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-300">Teléfono</p>
                                    <a href="tel:+34699984661" className="text-gray-400 hover:text-white transition-colors">
                                        +34 699 984 661
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="w-10 h-10 bg-[#EBC7DD]/10 rounded-xl flex items-center justify-center shrink-0">
                                    <MapPin className="w-5 h-5 text-[#EBC7DD]" />
                                </div>
                                <div>
